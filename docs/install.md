...
=== "x86_64/amd64"
    ```bash
    wget https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_x86_64.tar.gz
    tar zxvf ntfy_100.0.10_linux_x86_64.tar.gz
    sudo cp -a ntfy_100.0.10_linux_x86_64/ntfy /usr/bin/ntfy
    sudo mkdir /etc/ntfy && sudo cp ntfy_100.0.10_linux_x86_64/{client,server}/*.yml /etc/ntfy
    sudo ntfy serve
    ```

=== "armv6"
    ```bash
    wget https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_armv6.tar.gz
    tar zxvf ntfy_100.0.10_linux_armv6.tar.gz
    sudo cp -a ntfy_100.0.10_linux_armv6/ntfy /usr/bin/ntfy
    sudo mkdir /etc/ntfy && sudo cp ntfy_100.0.10_linux_armv6/{client,server}/*.yml /etc/ntfy
    sudo ntfy serve
    ```

=== "armv7/armhf"
    ```bash
    wget https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_armv7.tar.gz
    tar zxvf ntfy_100.0.10_linux_armv7.tar.gz
    sudo cp -a ntfy_100.0.10_linux_armv7/ntfy /usr/bin/ntfy
    sudo mkdir /etc/ntfy && sudo cp ntfy_100.0.10_linux_armv7/{client,server}/*.yml /etc/ntfy
    sudo ntfy serve
    ```

=== "arm64"
    ```bash
    wget https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_arm64.tar.gz
    tar zxvf ntfy_100.0.10_linux_arm64.tar.gz
    sudo cp -a ntfy_100.0.10_linux_arm64/ntfy /usr/bin/ntfy
    sudo mkdir /etc/ntfy && sudo cp ntfy_100.0.10_linux_arm64/{client,server}/*.yml /etc/ntfy
    sudo ntfy serve
    ```
...
=== "x86_64/amd64"
    ```bash
    wget https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_amd64.deb
...
=== "armv6"
    ```bash
    wget https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_armv6.deb
    sudo dpkg -i ntfy_*.deb
    sudo systemctl enable ntfy
    sudo systemctl start ntfy
    ```
...
=== "armv7/armhf"
    ```bash
    wget https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_armv7.deb
    sudo dpkg -i ntfy_*.deb
    sudo systemctl enable ntfy
    sudo systemctl start ntfy
    ```
...
=== "arm64"
    ```bash
    wget https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_arm64.deb
    sudo dpkg -i ntfy_*.deb
    sudo systemctl enable ntfy
    sudo systemctl start ntfy
    ```
...
=== "x86_64/amd64"
    ```bash
    sudo rpm -ivh https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_amd64.rpm
    sudo systemctl enable ntfy 
    sudo systemctl start ntfy
    ```
...
=== "armv6"
    ```bash
    sudo rpm -ivh https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_armv6.rpm
    sudo systemctl enable ntfy
    sudo systemctl start ntfy
    ```
...
=== "armv7/armhf"
    ```bash
    sudo rpm -ivh https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_armv7.rpm
    sudo systemctl enable ntfy 
    sudo systemctl start ntfy
    ```
...
=== "arm64"
    ```bash
    sudo rpm -ivh https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_100.0.10_linux_arm64.rpm
    sudo systemctl enable ntfy 
    sudo systemctl start ntfy
    ```
...
```bash
curl https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_v100.0.10_macOS_all.tar.gz > ntfy_v100.0.10_macOS_all.tar.gz
tar zxvf ntfy_v100.0.10_macOS_all.tar.gz
sudo cp -a ntfy_v100.0.10_macOS_all/ntfy /usr/local/bin/ntfy
mkdir ~/Library/Application\ Support/ntfy 
cp ntfy_v100.0.10_macOS_all/client/client.yml ~/Library/Application\ Support/ntfy/client.yml
ntfy --help
```
...
To install, please [download the latest ZIP](https://github.com/binwiederhier/ntfy/releases/download/v100.0.10/ntfy_v100.0.10_windows_x86_64.zip),
